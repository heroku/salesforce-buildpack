...
// FIXME: convert to secs
const SALESFORCE_ADDON_POLL_TIMEOUT_MS = parseInt(_.getEnvVarValue('SALESFORCE_ADDON_POLL_TIMEOUT', false, 3 * 60 * 1000 /* 6 min */));
const SALESFORCE_ADDON_POLL_INTERVAL_MS = parseInt(_.getEnvVarValue('SALESFORCE_ADDON_POLL_INTERVAL', false, 20 * 1000 /* 20 sec */));
